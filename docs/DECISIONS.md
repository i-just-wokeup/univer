...
- **헤더 원형 버튼 44** — 크기는 44인데 **원형 배경·radius가 없다.** 기록은 "원형 버튼 52→44"라 부분 일치
...
- **영상 60초/250MiB, 서버 65초** — 값은 확인됐으나 **5초 차이의 근거가 기록에 없다**
- **승격 자격(누적 10개 + 최근 30일 5개), 완주 95%·루프 85→15%** — 값은 명시됐으나 산정 근거 미기재
